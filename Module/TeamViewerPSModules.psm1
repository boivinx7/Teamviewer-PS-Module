...
function Set-TVPolicyToAllDevicesInGroup
{
	...
	foreach ($DID in $Devices)
	{
		...
		$percent = [math]::Round((($Start / $Count) * 100))
		Set-TVPolicyAssignement -DeviceID $DID -PolicyID
...
function Delete-TVDuplicateDevices
{
	...
	$header = New-Object "System.Collections.Generic.Dictionary[[String],[String]]"
	$header.Add("authorization", "Bearer  $token")
	$Users = Invoke-RestMethod -Uri "https://webapi.teamviewer.com/api/v1/users/$UserID" -Method Delete -Headers $header -ContentType application/json
	$Users
...
function Remove-TVUser ($parameter1, $parameter2)
{
